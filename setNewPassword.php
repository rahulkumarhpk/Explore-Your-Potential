<?php 
  ...
  if (!isset($_SESSION['passwordRecoveryEligibility'])) {
    ...
    <section class="form-26">
      ...
      <div class="form-inner-cont">
          ...
          <div class="form-right-inf"> 
             ...
             <!-- pass reset form starts -->
            
              <div class="forms-gds" id="resetPass" style="display: block">
              <form action="recover.php" method="post" class="signin-form"> 
                <div  class="form-input" style="overflow: hidden; white-space: nowrap;">
                  <span style="font-size: 20px; color: white">Enter new password: &nbsp;</span>
                  <input type="password" name="newPass" placeholder="New password" style="width: 30%" required />
                  <button class="btn" name="setNewPass" style="width: 25%; margin: 5px">Reset password</button>
                </div><br>
              </form>
              </div>
            
            <!-- pass reset form ends -->
